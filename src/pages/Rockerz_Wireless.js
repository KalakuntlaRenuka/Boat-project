...
export default function Rockerz_Wireless() {
  ...
  fetch("http://localhost:8000/addproducts").then((res)=>{
    ...
    return (
      ...
      <div className='container-fluid wireless_buds'>
        <center><h2>Rockerz Wireless</h2></center></div>
        ...
        <div className="row">
          ...
          {Users && Users.filter((Users)=>(Users.model === "Rockerz_Wireless")).map((filteredUsers) => (
